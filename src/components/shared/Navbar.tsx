    ...
    <div className="flex items-center justify-between w-[97%]">
      ...
      <Flex align="center" gap={20}>
        ...
        <div className="flex flex-col ">
          <h2 className="md:text-2xl text-lg  font-medium text-[#3A3C3B]">
            Welcome, Karan
            <span className="block  text-sm font-normal">Welcome back! Here's what's happening today.</span>
          </h2>
        </div>
      </Flex>
      ...
      <Flex align="center" gap={20}>
        ...
        <Link href={"/notifications"}>
          <div className="flex justify-center items-center size-12  rounded-2xl cursor-pointer relative border border-main-color bg-[#f2f3f4]">
          ...
          <MenubarMenu >
            <MenubarTrigger className="shadow-none px-0 rounded-full py-2">
              <div className="flex items-center gap-x-2  px-2 h-fit">
                <p className="text-black">Karan</p>
                <Avatar
                  src={avatarImg.src}
                  size={40}
                  className="size-12"
